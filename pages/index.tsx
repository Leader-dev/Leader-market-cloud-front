...
import {Center, Box, HStack, chakra, VStack, SimpleGrid} from "@chakra-ui/react";
    ...
    <BasicLayout>
      ...
      <HStack h={'60vh'} justify={"space-between"} w={'100%'} p={'0 5%'}>
        <Box w={'60%'}>
          ...
          <Box textStyle={"p"}>
            麟者 · 市场云线上平台正式开放。数轮的深化改⾰以及，激励着我们从原先数⼗⼈的微信社群⼀步步⾛到了今天。如今，已有⽆数影响⼒
            <chakra.span color={"paleBlue"}>
              ⻘年组织
            </chakra.span>
            与
            <chakra.span color={"paleBlue"}>
        ...
        <Box w={'30%'}>
          <Image objectFit={"cover"} borderRadius={'50px'} alt="watermelon yes!" src={watermelon}/>
        </Box>
      </HStack>
